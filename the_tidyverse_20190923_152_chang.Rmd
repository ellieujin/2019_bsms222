...
```
we will receive an error. With the function `summarize`, we can only call functions that return a single value. In Section 5.12, we will learn how to deal with functions that return more than one value.
...
## 5.10.2 Substes of tibbles are tibbles
